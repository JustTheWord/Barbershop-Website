#DROP DATABASE IF EXISTS grebegor;
#CREATE DATABASE IF NOT EXISTS grebegor COLLATE utf8_general_ci;
...
-- INSERT INTO grebegor.Clients (email, name, phone_num, birthday, password)
...
--
INSERT INTO grebegor.Appointment(appoint_date, clients_email, name, barber, service, price)
